...
//        if(len > 1024)
//        {
//            for(int i = 0;i<len/1024+(len%1024 > 0?1:0);i++)
//            {
//                remainLen = len -i*1024;
//                if(remainLen < 1024)
//                {
//                    relLen+=this->serial.write(data.mid(i*1024,remainLen),remainLen);
//                    qDebug()<<"last:"<<data.mid(i*1024,remainLen);
//                    this->serial.flush();
//                    break;
//                }
//                else
//                {
//                    relLen+=this->serial.write(data.mid(i*1024,1024),1024);
//                    this->serial.flush();
//                }
...
//        else
//        {
//            relLen = this->serial.write(data,data.length());
//        }
